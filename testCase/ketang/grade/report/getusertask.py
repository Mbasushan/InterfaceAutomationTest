...
#个人学习明细-作业明细
class Getusertask(unittest.TestCase):

    def setUp(self):
        self.base_url = "http://ke.test.mbalib.com/class/getusertask"
        self.access_token=Token.get_token_login('sxs14','123456')

    def test_getusertask(self):
        """个人学习明细-作业明细-单课"""
    ...
    def test_getusertask_column(self):
        """个人学习明细-作业明细-专栏"""
    ...
    def test_getusertask_noToken(self):
        """个人学习明细-作业明细-未登录"""
    ...
    def test_getusertask_noClassId(self):
        """个人学习明细-作业明细-未传班级key"""
    ...
    def test_getusertask_noUId(self):
        """个人学习明细-作业明细-未传用户ID"""
    ...
    def test_getusertask_noItype(self):
        """个人学习明细-作业明细-未传课程类型"""
    ...
    def test_getusertask_noItemId(self):
        """个人学习明细-作业明细-未传课程id"""
